...
<p align="center">I ❤️ solve great challenges using tech. <br><br> From backend development using Spring Boot to frontend development using Angular, I am <strong>passionate to discover new stuffs</strong> and use them to create high quality solutions. Today, I'm a <strong>full stack Junior developer</strong> focused on web development.</p>&nbsp;
